        ...
        try {
            ...
            if (response) {
                ...
                if (data && data.length > 0) {
                    ...
                    const dueWords = data.filter((key: FlashcardWord) => {
                        const reviewDate = new Date(key.nextReview);
    ...
    const handleReview = async (word: string, isCorrect: boolean) => {
        ...
        try {
            ...
            setTimeout(() => {
                ...
                if (isCorrect) {
                    updatedCount[word] = (updatedCount[word] || 0) + 1;
                } else {
                    updatedCount[word] = -1;
                }
                ...
                const [currentCard] = updatedQueue.splice(currentIndex, 1);
                ...
                if (updatedQueue.length === 0) {
                    ...
                    setCurrentIndex(
                        Math.min(currentIndex, updatedQueue.length - 1)
                    );
                }
            }, 300);
        } catch (error) {
                                ...
                                {!isFlipped ? (
                                    ...
                                    >
                                        ...
                                        <ul className="space-y-2">
                                            {words[currentIndex].meanings.map(
                                                (meaning, index) => (
                                                    <li
                                                        key={index}
